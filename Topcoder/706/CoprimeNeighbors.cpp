...
vector<long long> CoprimeNeighbors::findAny(int N) {
...
namespace moj_harness {
	...
	int run_test_case(int casenum__) {
		...
		case 0: {
			int N                     = 2;
			long long expected__[]    = {14, 25};

			clock_t start__           = clock();
			vector<long long> received__ = CoprimeNeighbors().findAny(N);
		...
		case 1: {
			int N                     = 3;
			long long expected__[]    = {1000000000000000000LL, 1, 1000000000000000000LL};
		...
		case 2: {
			int N                     = 6;
			long long expected__[]    = {14, 39, 80, 63, 26, 105};
